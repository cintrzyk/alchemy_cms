...
Gem::Specification.new do |gem|
  ...
  gem.add_runtime_dependency 'cancancan',                        ['~> 1.10']
  ...
  gem.add_runtime_dependency 'non-stupid-digest-assets',         ['~> 1.0.3', '< 1.0.7']
  gem.add_runtime_dependency 'rails',                            ['>= 4.0', '< 4.2']
  gem.add_runtime_dependency 'request_store',                    ['~> 1.0.3']
  gem.add_runtime_dependency 'sass-rails',                       ['>= 4.0', '<= 5.0.6']
